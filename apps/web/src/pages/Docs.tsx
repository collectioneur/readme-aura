        ...
        <thead>
          <tr className="bg-surface-highest">
            {headers.map((h) => (
              <th
                key={h}
                className="text-left px-4 py-3 font-grotesk text-teal-300 font-500 text-xs uppercase tracking-wider"
              >
                {h}
              </th>
            ))}
            ...
            <tr key={i} className={i % 2 === 0 ? 'bg-surface-low' : 'bg-surface'}>
              {row.map((cell, j) => (
                <td key={j} className="px-4 py-3 text-ink-secondary">
                  <code className="font-mono text-teal-300 text-xs">
                    {cell.startsWith('`') ? cell.slice(1, -1) : cell}
                  </code>
                  {!cell.startsWith('`') && j > 0 && (
...
export default function Docs() {
  ...
  useEffect(() => {
    const onResize = () => setWide500(window.innerWidth > 500);
      ...
      <div className="max-w-6xl mx-auto px-6 pt-24 pb-12 flex gap-12">
        ...
        <aside className="hidden lg:block w-52 flex-shrink-0">
          <div className="sticky top-20 pt-6">
            <p className="font-grotesk text-xs tracking-widest uppercase text-ink-muted mb-4">
              On this page
            </p>
        ...
        <main className="flex-1 min-w-0 pt-6">
          {/* Page title */}
          <div className="mb-12">
            <p className="font-grotesk text-xs tracking-[0.2em] uppercase text-teal-400 mb-3">
              Documentation
            </p>
            <MorphingCrystal
              text="readme-aura"
            ...
            <p className="text-ink-secondary text-lg leading-relaxed max-w-xl">
              Write custom React/JSX components directly inside your Markdown, and readme-aura will
              render them into beautiful SVGs that work on GitHub.
            </p>
            <p className="text-ink-muted text-sm mt-3 leading-relaxed">
              GitHub strips all JS and CSS from README files. This tool lets you bypass that
              limitation by compiling your designs into static SVG images at build time.
            </p>
          </div>

          {/* How It Works */}
          <section id="how-it-works" className="mb-14 scroll-mt-20">
            <h2 className="font-sans font-bold text-3xl text-gradient-bright tracking-tight mb-6">
              How It Works
            </h2>
            <ol className="space-y-4">
              {[
                [
                  'Run init',
                  'Run npx readme-aura init in your repo - creates workflow, source template, and audits .gitignore',
                ],
                [
                  'Edit source',
                  'Edit readme.source.md - add JSX components inside ```aura code blocks',
                ],
                [
                  'Preview locally',
                  'Preview locally with npx readme-aura build - JSX gets rendered to SVG via Vercel Satori',
                ],
          ...
          <section id="quick-start" className="mb-14 scroll-mt-20">
            <h2 className="font-sans font-bold text-3xl text-gradient-bright tracking-tight mb-4">
              Quick Start
            </h2>
            <p className="text-ink-secondary text-sm leading-relaxed mb-4">
              ...
              <code className="font-mono text-teal-300 text-xs">.gitignore</code> won't block
              generated files:
            </p>
            ...
            <p className="text-ink-secondary text-sm leading-relaxed">
              That's it. Push to <code className="font-mono text-teal-300 text-xs">main</code> and
              the workflow will auto-generate your{' '}
            ...
            <div className="mt-4 px-4 py-3 bg-surface-high rounded-xl border-l-2 border-teal-500">
              <p className="text-ink-secondary text-sm">
                <code className="font-mono text-teal-300 text-xs">init</code> auto-detects profile
                repos (<code className="font-mono text-teal-300 text-xs">username/username</code>)
                and picks the right template.
              </p>
            </div>
          </section>
          ...
          <section id="commands" className="mb-14 scroll-mt-20">
            ...
            <div className="overflow-x-auto rounded-xl">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-surface-highest">
                    <th className="text-left px-4 py-3 font-grotesk text-teal-300 font-500 text-xs uppercase tracking-wider">
                      Command
                    </th>
                    <th className="text-left px-4 py-3 font-grotesk text-teal-300 font-500 text-xs uppercase tracking-wider">
                      Description
                ...
                <tbody>
                  <tr className="bg-surface-low">
                    <td className="px-4 py-3 font-mono text-teal-300 text-xs">
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    <tr key={i} className={i % 2 === 0 ? 'bg-surface-low' : 'bg-surface'}>
                      <td className="px-4 py-3 font-mono text-teal-300 text-xs whitespace-nowrap">
                        {row[0]}
                      </td>
          ...
          <section id="what-init-creates" className="mb-14 scroll-mt-20">
            <h2 className="font-sans font-bold text-3xl text-gradient-bright tracking-tight mb-4">
              What <code className="text-teal-400 not-italic text-2xl">init</code> Creates
            </h2>
            ...
            <div className="space-y-6">
              <div>
                <p className="font-grotesk text-xs text-teal-300 mb-2 font-mono">
                  .github/workflows/readme-aura.yml
                </p>
                <p className="text-ink-secondary text-sm leading-relaxed mb-3">
                  GitHub Action that rebuilds your README on every push to{' '}
                  <code className="font-mono text-teal-300 text-xs">main</code> and on a daily
                  schedule (to keep GitHub stats fresh):
                </p>
        ...
        with:
          github_token: \${{ secrets.GITHUB_TOKEN }}`}</CodeBlock>
              ...
              <div>
                ...
                <p className="text-ink-secondary text-sm leading-relaxed">
                  Starter template with example{' '}
                  <code className="font-mono text-teal-300 text-xs">```aura</code> blocks,
                  customized for your repo type.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-ink-secondary text-sm leading-relaxed">
                  Ensures <code className="font-mono text-teal-300 text-xs">.github/assets/</code>,{' '}
                  <code className="font-mono text-teal-300 text-xs">.github/workflows/</code>,{' '}
                  <code className="font-mono text-teal-300 text-xs">README.md</code>, and{' '}
                  <code className="font-mono text-teal-300 text-xs">readme.source.md</code> are not
                  ignored.
                </p>
              </div>
            </div>
          ...
          <section id="features" className="mb-14 scroll-mt-20">
            ...
            <ul className="space-y-4">
              {[
                [
                  'Write React/JSX',
                  'Use familiar style={{ }} syntax with flexbox, gradients, shadows',
                ],
          ...
          <section id="animations" className="mb-14 scroll-mt-20">
            ...
            <p className="text-ink-secondary text-sm leading-relaxed mb-4">
              You can add <strong className="text-ink-bright">CSS-based SVG animations</strong>{' '}
              using the <code className="font-mono text-teal-300 text-xs">&lt;style&gt;</code>{' '}
              injection mechanism. Satori renders a static frame at build time; the browser animates
              the SVG when it is displayed on GitHub.
            </p>
            ...
            <div className="space-y-5">
              <div>
                ...
                <p className="text-ink-secondary text-sm leading-relaxed">
                  Add a <code className="font-mono text-teal-300 text-xs">&lt;style&gt;</code> block
                  in your JSX. Define{' '}
                  <code className="font-mono text-teal-300 text-xs">@keyframes</code> and apply them
                  to elements by <code className="font-mono text-teal-300 text-xs">#id</code> or{' '}
                  <code className="font-mono text-teal-300 text-xs">.class</code>. The renderer
                  extracts and injects the CSS into the final SVG.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-ink-secondary text-sm leading-relaxed">
                  <code className="font-mono text-teal-300 text-xs">transform</code> (translate,
                  scale, rotate), <code className="font-mono text-teal-300 text-xs">opacity</code>,{' '}
                  <code className="font-mono text-teal-300 text-xs">fill</code>, and{' '}
                  <code className="font-mono text-teal-300 text-xs">stroke-dasharray</code>/
                  <code className="font-mono text-teal-300 text-xs">stroke-dashoffset</code>. Layout
                  properties (<code className="font-mono text-teal-300 text-xs">width</code>,{' '}
                  <code className="font-mono text-teal-300 text-xs">height</code>,{' '}
                  <code className="font-mono text-teal-300 text-xs">margin</code>) are unreliable.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-ink-secondary text-sm leading-relaxed">
                  Use <code className="font-mono text-teal-300 text-xs">id</code> on SVG elements (
                  <code className="font-mono text-teal-300 text-xs">&lt;ellipse id="glow"&gt;</code>
                  ) and reference them in CSS:{' '}
                  <code className="font-mono text-teal-300 text-xs">
              ...
              <div className="px-4 py-3 bg-surface-high rounded-xl border-l-2 border-teal-500">
                <p className="text-ink-secondary text-sm">
                  <strong className="text-ink-bright">Limitations:</strong> No JavaScript, no SMIL.
                  GitHub strips scripts but supports CSS animations. Prefer{' '}
                  <code className="font-mono text-teal-300 text-xs">transform</code> and{' '}
                  <code className="font-mono text-teal-300 text-xs">opacity</code> for best
                  compatibility.
                </p>
              </div>
            </div>
          ...
          <div className="border-t border-surface-high pt-8">
            <Link
              to="/"
              className="inline-flex items-center gap-2 text-sm font-grotesk text-ink-muted hover:text-teal-300 transition-colors"
            >
              ← Back to home
            </Link>
          </div>
